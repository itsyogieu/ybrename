...
class TEXT:
    ...
    UPLOAD_SUCESS = f"Thanks for using [me](https://telegram.com/YBRenameBot)"
...
"""
 ...
 𝗜 𝗮𝗺 𝗮 𝗧𝗲𝗹𝗲𝗴𝗿𝗮𝗺 𝗬𝗕 𝗥𝗲𝗻𝗮𝗺𝗲𝗿 𝗕𝗼𝘁 𝘄𝗶𝘁𝗵 𝗣𝗲𝗿𝗺𝗮𝗻𝗲𝗻𝘁 𝗧𝗵𝘂𝗺𝗯𝗻𝗮𝗶𝗹.
...
**For Donate:** message me (https://bit.ly/3gwsct3)"""
